...
class GetMidocoAttributeDefinitionRequest extends AbstractStructBase
{
     ...
     */
    public function __construct(?\Pggns\MidocoApi\OrderSD\StructType\MidocoSystemAttributeDefinition $midocoSystemAttributeDefinition = null, ?string $orgunit = null)
    {
        $this
