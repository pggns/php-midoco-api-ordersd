...
class MidocoHttpRequest extends AbstractStructBase
{
     ...
     * @var \Pggns\MidocoApi\OrderSD\StructType\MidocoHttpHeader[]
     */
     ...
     * @var \Pggns\MidocoApi\OrderSD\StructType\MidocoHttpParameter[]
     */
     ...
     * @param \Pggns\MidocoApi\OrderSD\StructType\MidocoHttpHeader[] $midocoHttpHeader
     * @param \Pggns\MidocoApi\OrderSD\StructType\MidocoHttpParameter[] $midocoHttpParameter
     ...
     * @return \Pggns\MidocoApi\OrderSD\StructType\MidocoHttpHeader[]
     */
    ...
    public static function validateMidocoHttpHeaderForArrayConstraintFromSetMidocoHttpHeader(?array $values = []): string
    {
        ...
        foreach ($values as $midocoHttpRequestMidocoHttpHeaderItem) {
            ...
            if (!$midocoHttpRequestMidocoHttpHeaderItem instanceof \Pggns\MidocoApi\OrderSD\StructType\MidocoHttpHeader) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoHttpHeader property can only contain items of type \Pggns\MidocoApi\OrderSD\StructType\MidocoHttpHeader, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\OrderSD\StructType\MidocoHttpHeader[] $midocoHttpHeader
     * @return \Pggns\MidocoApi\OrderSD\StructType\MidocoHttpRequest
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\OrderSD\StructType\MidocoHttpHeader $item
     * @return \Pggns\MidocoApi\OrderSD\StructType\MidocoHttpRequest
     */
    public function addToMidocoHttpHeader(\Pggns\MidocoApi\OrderSD\StructType\MidocoHttpHeader $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\OrderSD\StructType\MidocoHttpHeader) {
            throw new InvalidArgumentException(sprintf('The MidocoHttpHeader property can only contain items of type \Pggns\MidocoApi\OrderSD\StructType\MidocoHttpHeader, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
     ...
     * @return \Pggns\MidocoApi\OrderSD\StructType\MidocoHttpParameter[]
     */
    ...
    public static function validateMidocoHttpParameterForArrayConstraintFromSetMidocoHttpParameter(?array $values = []): string
    {
        ...
        foreach ($values as $midocoHttpRequestMidocoHttpParameterItem) {
            // validation for constraint: itemType
            if (!$midocoHttpRequestMidocoHttpParameterItem instanceof \Pggns\MidocoApi\OrderSD\StructType\MidocoHttpParameter) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoHttpParameter property can only contain items of type \Pggns\MidocoApi\OrderSD\StructType\MidocoHttpParameter, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\OrderSD\StructType\MidocoHttpParameter $item
     * @return \Pggns\MidocoApi\OrderSD\StructType\MidocoHttpRequest
     */
    public function addToMidocoHttpParameter(\Pggns\MidocoApi\OrderSD\StructType\MidocoHttpParameter $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\OrderSD\StructType\MidocoHttpParameter) {
            throw new InvalidArgumentException(sprintf('The MidocoHttpParameter property can only contain items of type \Pggns\MidocoApi\OrderSD\StructType\MidocoHttpParameter, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
